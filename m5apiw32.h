...
#define SETUPID_MOD_SLAVE_DRIVE							0x00400000L
#define SETUPID_MOD_SW3_SCANNER							0x00800000L
...
//下面是我修改以后的Module States
#define MOD_ERROR								0x00000001L
#define MOD_HOME								0x00000002L
#define MOD_HALT								0x00000004L
#define MOD_POWERFAULT					0x00000008L
#define MOD_TOW_ERROR						0x00000010L
#define MOD_COMM_ERROR					0x00000020L
#define MOD_SWR									0x00000040L
#define MOD_SW1									0x00000080L
#define MOD_SW2									0x00000100L
#define MOD_BRAKEACTIVE 				0x00000200L
#define MOD_CURLIMIT						0x00000400L
#define MOD_MOTION							0x00000800L
#define MOD_RAMP_ACC						0x00001000L
#define MOD_RAMP_STEADY					0x00002000L
#define MOD_RAMP_DEC						0x00004000L
#define MOD_RAMP_END						0x00008000L
#define MOD_INPROGRESS					0x00010000L
#define MOD_FULLBUFFER					0x00020000L
#define MOD_POW_VOLT_ERR				0x00040000L
#define MOD_POW_FET_TEMP				0x00080000L
#define MOD_POW_WDG_TEMP				0x00100000L
#define MOD_POW_SHORTCUR				0x00200000L
#define MOD_POW_HALLERR					0x00400000L
#define MOD_POW_INTEGRALERR			0x00800000L
#define MOD_CPU_OVERLOAD				0x01000000L
#define MOD_BEYOND_HARD				  0x02000000L
#define MOD_BEYOND_SOFT					0x04000000L
#define MOD_LOGIC_VOLT					0x08000000L
#define MOD_OVERSHOOT						0x10000000L
#define MOD_UNDERSHOOT					0x20000000L
//-----------------------------------------------------------------------
...
M5DLL_API int WINAPI PCube_setMotorCurOffset( int iDeviceId, int iModuleId, float fValue );
M5DLL_API int WINAPI PCube_getMotorCurOffset( int iDeviceId, int iModuleId, float* pfValue );
M5DLL_API int WINAPI PCube_setPos( int iDeviceId, int iModuleId, float fValue );
M5DLL_API int WINAPI PCube_setPosInc( int iDeviceId, int iModuleId, long iValue );
M5DLL_API int WINAPI PCube_getScannerPosFallEdge( int iDeviceId, int iModuleId, float* pfValue, unsigned short* pTime );
M5DLL_API int WINAPI PCube_getScannerPosRisgEdge( int iDeviceId, int iModuleId, float* pfValue, unsigned short* pTime );
